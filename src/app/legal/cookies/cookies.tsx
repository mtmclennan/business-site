    ...
    <div className="terms__container">
      ...
      <div className="terms__wrapper">
        <section className="terms">
          ...
          <p>Introduction</p>
          <p>
            Welcome to EdgeInBusiness.com. This website uses cookies to improve
            your browsing experience and to provide us with valuable information
            on how our website is being used. This Cookie Policy explains what
          ...
          <p>
            EdgeInBusiness.com may use third-party services that place cookies
            on your device. These third-party cookies are subject to their
          ...
          <p>Your Consent</p>
          <p>
            By using EdgeInBusiness.com, you consent to the use of cookies as
          ...
          <p>
            EdgeInBusiness reserves the right to update or modify this Cookie
            Policy from time to time. Any changes will be effective immediately
            upon posting on our website. We encourage you to review this policy
          ...
          <p>
            By using EdgeInBusiness.com, you acknowledge that you have read and
